<?php
    ...
    $celkovypocetNavstev = file_get_contents('pocitadlo.txt');
    var_dump($celkovypocetNavstev);
    $celkovypocetNavstev = intval($celkovypocetNavstev) + 1;
    file_put_contents('pocitadlo.txt', $celkovypocetNavstev);
...
<body>
    ...
    <h1>Celkem: <?= $celkovypocetNavstev ?> </h1>
</body>
</html>